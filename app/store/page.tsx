...
export const metadata: Metadata = {
  title: "Store Demo | Zenixa",
  description: "Experience the Zenixa e-commerce platform. Browse products, explore features, and see what your store could look like.",
}
        ...
        <section className="py-12 md:py-20">
          <div className="container mx-auto px-4">
            <div className="flex items-end justify-between mb-8 md:mb-12">
              ...
              <Link href="/store/categories" className="hidden md:block">
        ...
        <section className="py-12 md:py-20 bg-secondary/30 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-6">
              {featuredProducts.map((product: { id: string }) => (
      ...
      {latestProducts.length > 0 && (
        <section className="py-12 md:py-20">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-6">
              {latestProducts.map((product: { id: string }) => (
                <div key={product.id} className="h-full">
                  <ModernProductCard product={product as any} />
                </div>
              ))}
